...
public class UIElements {
    ...
    public static class OfflineScreen {
        public static String progressBar = "com.company.mysapcpsdkprojectoffline:id/main_bus_progress_bar";
        public static int progressbar = R.id.main_bus_progress_bar;
    }
