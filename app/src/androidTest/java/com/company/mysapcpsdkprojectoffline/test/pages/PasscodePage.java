package com.company.mysapcpsdkprojectoffline.test.pages;
...
import com.company.mysapcpsdkprojectoffline.test.core.AbstractPasscodePage;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("com.company.mysapcpsdkprojectoffline:id/passcode_field")).setText(passcode);
        ...
        public void clickResetAppButton() {
         ...
         public void clickResetDialogWithText(){
                    onView(withText("RESET CLIENT"))
                            .inRoot(isDialog())
                            .check(matches(isDisplayed()))
                            .perform(click());
                }
