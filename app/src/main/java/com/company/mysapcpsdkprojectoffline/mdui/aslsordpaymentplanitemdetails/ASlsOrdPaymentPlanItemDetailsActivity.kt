 ...
 * - [ASlsOrdPaymentPlanItemDetailsCreateFragment]: to create or edit a(n) ASlsOrdPaymentPlanItemDetailsType,
 * - [ASlsOrdPaymentPlanItemDetailsDetailFragment]: to display the details of a(n) ASlsOrdPaymentPlanItemDetailsType,
 * - [ASlsOrdPaymentPlanItemDetailsListFragment]: to list ASlsOrdPaymentPlanItemDetails.
 *
 ...
 * what to do.
 */
class ASlsOrdPaymentPlanItemDetailsActivity : AppCompatActivity(), InterfacedFragment.InterfacedFragmentListener<ASlsOrdPaymentPlanItemDetailsType> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, ASlsOrdPaymentPlanItemDetailsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit()
        } else {
    ...
    override fun onFragmentStateChange(evt: Int, entity: ASlsOrdPaymentPlanItemDetailsType?) {
        when (evt) {
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ASlsOrdPaymentPlanItemDetailsCreateFragment}.
     */
    ...
    private fun onItemClicked(entity: ASlsOrdPaymentPlanItemDetailsType?) {
        if (!isMasterDetailView) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, ASlsOrdPaymentPlanItemDetailsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if (detail == null) {
                if (entity != null)
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.detailFrame, ASlsOrdPaymentPlanItemDetailsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                        .commit()
            } else {
                if( entity == null) {
    ...
    private fun onCreateNewItem() {
        ...
        val fragment = ASlsOrdPaymentPlanItemDetailsCreateFragment()
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onEditItem(entity: ASlsOrdPaymentPlanItemDetailsType?) {
        val updateFragment = ASlsOrdPaymentPlanItemDetailsCreateFragment()
        val arguments = Bundle()
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            if (activity != null) {
                ...
                builder.setPositiveButton(R.string.before_navigation_dialog_positive_button) { _, _ ->
                    (fragmentActivity as ASlsOrdPaymentPlanItemDetailsActivity).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null)
                }
    ...
    internal class DelelteConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            if (activity !=null) {
                val fragmentActivity = activity as AppCompatActivity
                val builder = AlertDialog.Builder(ContextThemeWrapper(fragmentActivity, R.style.AlertDialogStyle))
                val viewModel = ViewModelProvider(fragmentActivity).get(ASlsOrdPaymentPlanItemDetailsTypeViewModel::class.java)
