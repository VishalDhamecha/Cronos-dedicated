package com.company.mysapcpsdkprojectoffline.viewmodel.asalesorderitemtype
...
/*
 * Represents View model for ASalesOrderItemType
 *
 ...
 */
class ASalesOrderItemTypeViewModel(application: Application): EntityViewModel<ASalesOrderItemType>(application, EntitySets.aSalesOrderItem, ASalesOrderItemType.higherLevelItem) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ASalesOrderItemType>(application, EntitySets.aSalesOrderItem, ASalesOrderItemType.higherLevelItem, navigationPropertyName, entityData)
    }
}
