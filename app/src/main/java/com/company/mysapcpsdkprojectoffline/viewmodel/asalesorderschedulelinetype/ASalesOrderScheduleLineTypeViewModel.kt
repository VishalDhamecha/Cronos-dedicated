package com.company.mysapcpsdkprojectoffline.viewmodel.asalesorderschedulelinetype
...
/*
 * Represents View model for ASalesOrderScheduleLineType
 *
 ...
 */
class ASalesOrderScheduleLineTypeViewModel(application: Application): EntityViewModel<ASalesOrderScheduleLineType>(application, EntitySets.aSalesOrderScheduleLine, ASalesOrderScheduleLineType.requestedDeliveryDate) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ASalesOrderScheduleLineType>(application, EntitySets.aSalesOrderScheduleLine, ASalesOrderScheduleLineType.requestedDeliveryDate, navigationPropertyName, entityData)
    }
}
