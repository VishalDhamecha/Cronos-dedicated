package com.company.mysapcpsdkprojectoffline.viewmodel.asalesorderheaderprelementtype
...
/*
 * Represents View model for ASalesOrderHeaderPrElementType
 *
 ...
 */
class ASalesOrderHeaderPrElementTypeViewModel(application: Application): EntityViewModel<ASalesOrderHeaderPrElementType>(application, EntitySets.aSalesOrderHeaderPrElement, ASalesOrderHeaderPrElementType.conditionType) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ASalesOrderHeaderPrElementType>(application, EntitySets.aSalesOrderHeaderPrElement, ASalesOrderHeaderPrElementType.conditionType, navigationPropertyName, entityData)
    }
}
