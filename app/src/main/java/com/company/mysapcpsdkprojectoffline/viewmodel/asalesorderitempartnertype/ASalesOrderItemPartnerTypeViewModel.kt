package com.company.mysapcpsdkprojectoffline.viewmodel.asalesorderitempartnertype
...
/*
 * Represents View model for ASalesOrderItemPartnerType
 *
 ...
 */
class ASalesOrderItemPartnerTypeViewModel(application: Application): EntityViewModel<ASalesOrderItemPartnerType>(application, EntitySets.aSalesOrderItemPartner, ASalesOrderItemPartnerType.customer) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ASalesOrderItemPartnerType>(application, EntitySets.aSalesOrderItemPartner, ASalesOrderItemPartnerType.customer, navigationPropertyName, entityData)
    }
}
